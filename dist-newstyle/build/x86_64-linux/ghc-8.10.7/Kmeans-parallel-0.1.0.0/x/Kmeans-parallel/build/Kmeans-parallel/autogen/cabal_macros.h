...
/* package Kmeans-parallel-0.1.0.0 */
#ifndef VERSION_Kmeans_parallel
#define VERSION_Kmeans_parallel "0.1.0.0"
#endif /* VERSION_Kmeans_parallel */
#ifndef MIN_VERSION_Kmeans_parallel
#define MIN_VERSION_Kmeans_parallel(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Kmeans_parallel */
...
#define CURRENT_COMPONENT_ID "Kmeans-parallel-0.1.0.0-inplace-Kmeans-parallel"
